...
class AppColors {
  ...
  static const Color secondary = Color(0xFFDCD6F7); // Lavender lilac (Old: 0xFFC9ADA7)
  static const Color muted = Color(0xFFE5E0FF); // Soft pastel lilac (Old: 0xFFDDD5D0)

  // Neutral colors (~Seashell)
  static const Color background = Color(0xFFF8F4FF); // Unified DNA quiz lavender pastel background (Old: 0xFFF2E9E4)
  static const Color surface = Color(0xFFFDFBFF); // White with hint of lavender (Old: 0xFFFAF6F4)
